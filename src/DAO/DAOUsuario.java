...
public class DAOUsuario extends ConexaoMySql {
    ...
    public static String QualBanco;    
    ...
    /**
     * Validar login e senha para acesar o sistema, este login e senha só deve
     * ser configurado pelo pessoal da SSD
     *
     * @param pmodelUsuario
     * @return
     */
    public boolean getValidarUsuarioDAO(ModelUsuario pmodelUsuario) {
        try {
            setOndeConectar(QualBanco);
            //aqui que coloco onde o banco vai se conectar
    ...
    /**
     * @param pOndeConectar the QualBanco to set
     */
    public void setQualBanco(String pOndeConectar) {
        this.QualBanco = pOndeConectar;
    }
}
