...
public class ModelCliente {
    ...
    private String cliDDDTel;
    private String cliPontoReferencia;
    ...
    */
    ...
    public String getCliDDDTel() {
        return cliDDDTel;
    }

    public void setCliDDDTel(String cliDDDTel) {
        this.cliDDDTel = cliDDDTel;
    }

    /**
     * @return the cliPontoReferencia
     */
    public String getCliPontoReferencia() {
        return cliPontoReferencia;
    }

    /**
     * @param cliPontoReferencia the cliPontoReferencia to set
     */
    public void setCliPontoReferencia(String cliPontoReferencia) {
        this.cliPontoReferencia = cliPontoReferencia;
    }
}