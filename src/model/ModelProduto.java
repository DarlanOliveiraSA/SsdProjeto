...
/**
 * Um model produtos é um construtor de cada produto contendo ID, NOME, VALOR, E
 * ESTOQUE. basicamente só serve para definir uma estrutura de um produto mesmo
 *
 * @author Darlan
 */
public class ModelProduto {
    ...
    public String toString() {
        return getProNome() + "foi vendido: " + getProQuantidadeVendida() + getProEstoque();
    }
