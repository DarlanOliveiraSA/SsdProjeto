package model;
/**
*Construtor ou modelo do objeto forma de pagamento, aqui temos os tributos
* idDaForPag int, String descricaoForPag que é o nome, parcelasForPag e situacaoForPag.
* @author Darlan
*/
