 ...
 * @author Darlan
 */
public class ViewPDVTeste extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jlLogo.setIcon(new javax.swing.ImageIcon(getClass().getResource("/imagens/logo da empresa.jpg"))); // NOI18N
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(ViewPDVTeste.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new ViewPDVTeste().setVisible(true);
            }
        });
    }
