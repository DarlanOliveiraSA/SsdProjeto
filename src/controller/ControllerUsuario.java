...
public class ControllerUsuario {
    ...
    /**
     * Esta tag seleciona qual banco será conectado durante a execução do programa
     * @param pOndeConectar
     */
    public void selecionarQualBanco(String pOndeConectar){
    this.daoUsuario.setQualBanco(pOndeConectar);
    }
